...
from ContigFilterPython.ContigFilterPythonImpl import ContigFilterPython


class ContigFilterPythonTest(unittest.TestCase):
    ...
    def getWsName(self):
        ...
        wsName = "test_ContigFilterPython_" + str(suffix)
